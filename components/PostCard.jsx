...
function PostCard({post}) {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      <div className='relative overflow-hidden rounded-t-lg lg:shadow-md pb-80 mb-6 lg:rounded-lg'>
        <img 
      ...
      <h1 className='transition duration-700 text-center text-slate-800 sm:mx-1 mb-8 cursor-pointer hover:text-pink-600 text-3xl font-semibold'>
